...
TJSONProtocol.prototype.writeStructEnd = function() {
  ...
  str += '}';
  console.log("TJSONProtocol.prototype.writeStructEnd", str)
  //this.tstack[p] = str;
  this.tstack[p] = str.replace(/\\/g,"");
...
TJSONProtocol.prototype.writeString = function(arg) {
  ...
  if (arg === null) {
	  ...
	  console.log("TJSONProtocol.prototype.writeString", str)
      var escapedString = '';
      for (var i = 0; i < str.length; i++) {
         ...
         //     escapedString += '\\\"'; // write out as: \"
           ...
           */
         // } else  
		  if (ch === '\b') {    // a single backspace: invisible
